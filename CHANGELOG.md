...
- build: remove registries from .npmrc (● [26d6b07](https://github.com/zerocluster/node/commit/26d6b07); 👬 zdm)

Compare with the previous release: [v1.10.9...v1.10.10](https://github.com/zerocluster/node/compare/v1.10.9...v1.10.10)

### v1.10.9 (2026-05-16)

**Other changes:**

- docs: update (● [f1943d0](https://github.com/zerocluster/node/commit/f1943d0); 👬 zdm)

Compare with the previous release: [v1.10.8...v1.10.9](https://github.com/zerocluster/node/compare/v1.10.8...v1.10.9)
...
- chore(metadata): update package metadata (● [6f4d2d7](https://github.com/zerocluster/node/commit/6f4d2d7); 👬 zdm)

Compare with the previous release: [v1.9.1](https://github.com/zerocluster/node/compare/v1.9.1...v1.9.2)
...
- build: migrate to c0rejs namespace (● [8a83ccb](https://github.com/zerocluster/node/commit/8a83ccb), [0a1e89c](https://github.com/zerocluster/node/commit/0a1e89c); 👬 zdm)

Compare with the previous release: [v1.7.2](https://github.com/zerocluster/node/compare/v1.7.2...v1.7.3)
